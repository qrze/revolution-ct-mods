...
var init = () => {
    ...
    // q2
    {
        ...
        q2 = theory.createUpgrade(1, currency, new ExponentialCost((1000, 3.38*3)^1.5);
    ...
    // n
    {
        ...
        n = theory.createUpgrade(2, currency, new ExponentialCost((20, 3.38)^1.5);
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(3, currency, new ExponentialCost((50, 3.38/1.5)^1.5);
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(4, currency, new ExponentialCost((1e10, 3.38*10)^1.5));
...
var getPublicationMultiplier = (tau) => tau.isZero ? BigNumber.ONE : tau.pow(BigNumber.from((1.5/tauMultiplier)/2);
