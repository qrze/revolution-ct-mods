...
var init = () => {
    ...
    // q1
    {
        ...
        q1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(1, 10)));
    ...
    // q2
    {
        ...
        q2 = theory.createUpgrade(1, currency, new ExponentialCost(1, 10));
    ...
    // n
    {
        ...
        n = theory.createUpgrade(2, currency, new ExponentialCost(1, 10));
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(3, currency, new ExponentialCost(1, 10));
...
var getPublicationMultiplier = (tau) => tau.isZero ? BigNumber.ONE : tau.pow(BigNumber.from(5/tauMultiplier));
var getPublicationMultiplierFormula = (symbol) => "{" + symbol + "}^{10}";
var getTau = () => currency.value.pow(BigNumber.from(1*tauMultiplier));
var getCurrencyFromTau = (tau) => [tau.max(BigNumber.ONE).pow(5/tauMultiplier), currency.symbol];
