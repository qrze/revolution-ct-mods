...
var id = "SL MOD"; //must be unique, make sure to change it 
var name = "SL MOD"; //display name
...
var authors = "qrze"; //display author in the "author" field
...
var init = () => {
    ...
    // Permanent Upgrades
    theory.createPublicationUpgrade(0, currency, 1 ); //unlock publications at 1e10 currency
    theory.createBuyAllUpgrade(1, currency, 1); //unlock buy all at 1e15 currency
    theory.createAutoBuyerUpgrade(2, currency, 1); //unlock autobuyer at 1e20 currency
...
var getPublicationMultiplier = (tau) => tau.pow(10/tauMultiplier); //publication mult bonus is (tau^0.15)*100
var getPublicationMultiplierFormula = (symbol) => /*"10 · " +*/ symbol + "^{0.375}"; //text to render for publication mult ext
var getTau = () => currency.value.pow(BigNumber.from(10*tauMultiplier));
